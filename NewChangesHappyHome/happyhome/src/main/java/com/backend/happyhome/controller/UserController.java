...
import com.backend.happyhome.responsedtos.LoginResponseDtoC;
...
public class UserController {
	...
	ResponseEntity<LoginResponseDtoC> login(@RequestBody UserLoginDtoC userDto){
		...
		if(user != null) {
			...
			ResponseEntity<LoginResponseDtoC> res = new ResponseEntity<LoginResponseDtoC>(new LoginResponseDtoC("Success",user.getUserId()), headers, HttpStatus.OK);
			return res;
		}else {
